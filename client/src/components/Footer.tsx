  ...
  return (
    <footer className="bg-gradient-to-r from-red-400 via-blue-400 to-yellow-400 border-t-4 border-yellow-400 py-12 mt-16 relative transform rotate-1">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <img src="/one.png" alt="" className="absolute top-5 left-10 w-6 h-6 md:w-10 md:h-10 opacity-40 transform rotate-45" style={{ animation: 'paperShake 4s ease-in-out infinite', animationDelay: '0s' }} />
        <img src="/two.png" alt="" className="absolute bottom-5 right-20 w-5 h-5 md:w-8 md:h-8 opacity-35 transform -rotate-30" style={{ animation: 'sway 3s ease-in-out infinite', animationDelay: '1s' }} />
        <img src="/three.png" alt="" className="absolute top-8 right-1/3 w-4 h-4 md:w-6 md:h-6 opacity-30 transform rotate-90" style={{ animation: 'crumple 5s ease-in-out infinite', animationDelay: '2s' }} />
        <img src="/four.png" alt="" className="absolute bottom-8 left-1/4 w-5 h-5 md:w-8 md:h-8 opacity-45 transform -rotate-45" style={{ animation: 'float 2.5s ease-in-out infinite', animationDelay: '1.5s' }} />
      </div>
