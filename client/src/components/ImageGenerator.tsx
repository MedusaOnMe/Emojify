...
export default function ImageGenerator() {
  ...
  const processMutation = useMutation({
    mutationFn: async () => {
      ...
      const hardcodedPrompt = "Generate a custom Pokémon card based on this photo in the classic Pokémon card style, portrait format. Turn the person/subject into a Pokémon character. Analyze the image and create: **Name**: Generate a savage, hilarious Pokémon name based on what you see - their appearance, expression, clothing, objects, pose, or any details. Make it brutally clever. **Type**: Randomly assign any Pokémon type. **HP**: Random 60-180. **Stats**: Random weakness (2x damage), resistance (-20 damage), retreat cost (1-3 energy). **2 Attacks** - Make these absolutely ruthless and creative based on the image: Attack names should be savage roasts of their appearance, expression, clothing, pose, or any visible details. Damage: Random 20-120. Effects: Brutal, witty descriptions that drag specific things you see. Don't hold back - be creative, edgy, and genuinely funny. Think of the kind of roasts that would go viral. Examples: 'Bad Haircut Beam', 'Awkward Smile Slam', 'Questionable Fashion Choice', 'Dead Eyes Stare', 'Cringe Overload', 'Reality Check Slap'. Reference specific clothing colors, facial expressions, poses, accessories, backgrounds - anything visible. Make it the kind of humor that's shocking but hilarious. **Background**: Match the assigned type. Create something so funny people screenshot it immediately."
