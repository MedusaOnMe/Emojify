...
export default function ImageGenerator() {
  ...
  const processMutation = useMutation({
    mutationFn: async () => {
      ...
      const hardcodedPrompt = "Generate a custom Pokémon trading card based on this photo. Create a TALL PORTRAIT RECTANGLE Pokemon card (2:3 aspect ratio like real Pokemon cards) that fills the entire canvas. Turn the person/subject into a Pokémon character. Design elements: **Card Layout**: Classic Pokemon card border, holographic effects, tall portrait format. **Name**: Generate a savage, hilarious Pokémon name based on what you see - their appearance, expression, clothing, objects, pose, or any details. Make it brutally clever. **Type**: Randomly assign any Pokémon type with matching symbol. **HP**: Random 60-180 in top right. **Character Art**: Large central portrait of them as a Pokemon in dynamic pose. **2 Attacks** - Make these absolutely ruthless and creative: Attack names should be savage roasts of their appearance, expression, clothing, pose, or visible details. Damage: Random 20-120. Effects: Brutal, witty descriptions that drag specific things you see. Don't hold back - be creative, edgy, genuinely funny. Think viral roasts. Examples: 'Bad Haircut Beam', 'Awkward Smile Slam', 'Questionable Fashion Choice', 'Dead Eyes Stare', 'Cringe Overload', 'Reality Check Slap'. Reference specific clothing colors, facial expressions, poses, accessories, backgrounds. **Bottom Stats**: Weakness, resistance, retreat cost, card number. **Background**: Match assigned type with gradients. IMPORTANT: Make the card TALL and PORTRAIT oriented, not square. The final result should be a complete Pokemon trading card in portrait format."
